...
public class _I18NFrmMSingJointPostBEdit {

  public static final Locale locale = new Locale("en", "", "");

  public static final String RES_NAME = "com.minotauro.sandbox.gui.msingjointpostb.FrmMSingJointPostBEdit";

  private _I18NFrmMSingJointPostBEdit() {
    // Empty
  }
