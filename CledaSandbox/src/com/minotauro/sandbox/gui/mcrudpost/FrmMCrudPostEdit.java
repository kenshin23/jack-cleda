...
public class FrmMCrudPostEdit extends FrmEditBase {
		...
		fmDesc.getValidatorList().add(
				ConditionalValidator
						...
						.add(new NotEmptyValidator(
								_I18NFrmMCrudPostEdit.desc(), txtDesc))
						.add(ConditionalValidator
								.CHAIN(true)
								.add(new NotEmptyValidator(
										_I18NFrmMCrudPostEdit.desc(), txtDesc))
								.add(new IntegerValidator(_I18NFrmMCrudPostEdit
										.desc(), txtDesc))));
	...
	protected FieldModel initjointAB() {
		...
		EJointButton jntJoint = new EJointButton(FrmMMultJointMPostAList.class,
				jointModel, this);

		jntJoint.setEditMode(editMode);

		FieldModel fmJoint = new FieldModel();
		fmJoint.setLabelCmp(new EFieldLabel(_I18NFrmMCrudPostEdit.jointAB())); // TODO:
																				// editar
																				// properties
	...
	protected FieldModel initjointPostB() {
		...
		FieldModel fmJoint = new FieldModel();
		fmJoint.setLabelCmp(new EFieldLabel(_I18NFrmMCrudPostEdit.jointPostB())); // TODO:
																					// editar
																					// properties
		fmJoint.setFieldCmp(jntJoint);
