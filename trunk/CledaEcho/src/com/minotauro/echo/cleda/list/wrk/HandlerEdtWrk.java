 ...
 */
public class HandlerEdtWrk implements CommandListener {

  protected FrmListBase frmBaseList;

  // --------------------------------------------------------------------------------

  public HandlerEdtWrk(FrmListBase frmBaseList) {
  ...
  protected void failsafeDocClicked(int row) throws Exception {
