 ...
 */
public class FrmDMultJointACList extends FrmListJointMultBase {

  public FrmDMultJointACList() {
    frmEditDtaClass = FrmMCrudCEdit.class;
    frmEditRelClass = FrmDMultJointACEdit.class;
    setTitle(_I18NFrmDMultJointACList.title());
  }
  ...
  protected TableColModel initTableColModel() {
    ...
    tableColumn = new TableColumn() {
      public Object getValue(ETable table, Object element) {
        DMultJointAC multJointAC = (DMultJointAC) jointModel.get((MCrudC) element);

        if (multJointAC != null) {
          return multJointAC.getMainARef().getName();
        }

        return _I18NFrmDMultJointACList.na();
      }
    };
    tableColumn.setWidth(new Extent(30, Extent.PERCENT));
    tableColumn.setDataCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadValue(_I18NFrmDMultJointACList.aName());
    tableColModel.getTableColumnList().add(tableColumn);
    ...
    tableColumn.setDataCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadValue(_I18NFrmDMultJointACList.rName());
    tableColModel.getTableColumnList().add(tableColumn);
    ...
    tableColumn.setDataCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadValue(_I18NFrmDMultJointACList.bName());
    tableColModel.getTableColumnList().add(tableColumn);
