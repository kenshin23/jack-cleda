...
public class _I18NFrmDMultJointACEdit {

  public static final Locale locale = new Locale("en", "", "");

  public static final String RES_NAME = "com.minotauro.sandbox.gui.dmultjointac.FrmDMultJointACEdit";

  private _I18NFrmDMultJointACEdit() {
    // Empty
  }
