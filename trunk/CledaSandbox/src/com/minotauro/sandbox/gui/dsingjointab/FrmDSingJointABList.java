 ...
 */
public class FrmDSingJointABList extends FrmListJointSingBase {

  public FrmDSingJointABList() {
    frmEditDtaClass = FrmMCrudBEdit.class;
    setTitle(_I18NFrmDSingJointABList.title());
  }
  ...
  protected TableColModel initTableColModel() {
    ...
    tableColumn = new TableColumn() {
      public Object getValue(ETable table, Object element) {
        DSingJointAB singJointAB = (DSingJointAB) jointModel.get((MCrudB) element);

        if (singJointAB != null) {
          return singJointAB.getMainARef().getName();
        }

        return _I18NFrmDSingJointABList.na();
      }
    };
    tableColumn.setWidth(new Extent(45, Extent.PERCENT));
    tableColumn.setDataCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadValue(_I18NFrmDSingJointABList.aName());
    tableColModel.getTableColumnList().add(tableColumn);
    ...
    tableColumn.setDataCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadCellRenderer(new LabelCellRenderer());
    tableColumn.setHeadValue(_I18NFrmDSingJointABList.bName());
    tableColModel.getTableColumnList().add(tableColumn);
