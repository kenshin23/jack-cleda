...
public class _I18NFrmMSingJointACEdit {

  public static final Locale locale = new Locale("en", "", "");

  public static final String RES_NAME = "com.minotauro.sandbox.gui.msingjointac.FrmMSingJointACEdit";

  private _I18NFrmMSingJointACEdit() {
    // Empty
  }
