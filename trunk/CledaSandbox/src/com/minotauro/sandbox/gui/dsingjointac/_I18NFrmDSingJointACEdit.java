...
public class _I18NFrmDSingJointACEdit {

  public static final Locale locale = new Locale("en", "", "");

  public static final String RES_NAME = "com.minotauro.sandbox.gui.dsingjointac.FrmDSingJointACEdit";

  private _I18NFrmDSingJointACEdit() {
    // Empty
  }
